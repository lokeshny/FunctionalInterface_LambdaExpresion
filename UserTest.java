...
public class UserTest {
    ...
    public void firstNameHappyTest() throws InvalidUserDetailsException {
        boolean firstName = user.setfName("Lokesh");
